...
const EditProfile = () => {
  ...
  return (
    <div className="flex justify-center">
      <div className="w-full max-w-lg bg-bg border border-border rounded-xl p-4">
        ...
        <form onSubmit={handleSubmit} className="space-y-2">
          ...
          <button
            type="submit"
            disabled={updating}
            className="flex items-center justify-center gap-2 bg-primary px-4 py-2 rounded-lg w-full text-white"
          >
            <Save size={18} />
